...
def data_cleaner():
    import pandas as pd
    import re
    df = pd.read_csv(AIRFLOW_HOME + '/dags/store_files/raw_store_transactions.csv')
    ...
    df.to_csv(AIRFLOW_HOME + '/dags/store_files/clean_store_transactions.csv', index=False)
